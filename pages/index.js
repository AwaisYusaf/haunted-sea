      ...
      <main className={styles.container}>
        ...
        <section className={styles.section1}>
          <div className={styles.left1}>
            <div>
              <h1>
                <span>Bait up and Fish</span> for extraordinary NFTs <br />
                secured with blockchain on Fantom
              </h1>
              <h2>
                The first ever NFT marketplace and <br />
                and Virtual World on the Fantom Network
              </h2>
              ...
              <div className={styles.social_links_container}>
                <div className={styles.social_links}>
                  <div className={styles.social_link_icon}>
                    <a
                      href="https://www.twitter.com/HauntedSeaio"
                      target="_blank"
                      rel="noreferrer"
                    >
                  ...
                  <div className={styles.social_link_icon}>
                    <a
                      href="https://t.me/HauntedSeaOfficial"
                      target="_blank"
                      rel="noreferrer"
                    >
                  ...
                  <div className={styles.social_link_icon}>
                    <a
                      href="https://t.me/hauntedseaannouncements"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <img src="/Icons/telegram.png" />
            ...
            <div className={styles.section3cards}>
              ...
              >
                ...
                <SwiperSlide>
                  <Card3
                    title="Collectibles"
                    imgUrl="/assets/collectible.png"
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <Card3
                    title="Virtual Worlds"
                    imgUrl="/assets/ctg1.jpeg"
                    // extraPadding={true}
                  />
                </SwiperSlide>
                <SwiperSlide>
                ...
                <SwiperSlide>
                  <Card3
                    title="Photography"
                    imgUrl="/assets/ctg5.jpeg"
                    // extraPadding={true}
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <Card3 title="Domain names" imgUrl="/assets/ctg6.jpeg" />
                </SwiperSlide>
              </Swiper>
              <img
                src="/assets/jellyfish1.png"
                alt="jellyfish"
                id="jellyfish"
                className={styles.jellyfish3}
              />
            </div>
          </section>
          ...
          <section className={styles.section5}>
            ...
            <div className={styles.section5cards}>
              <div className={styles.card5}>
                <div
                  style={{ backgroundImage: "url(/assets/overlay2.png)" }}
                ...
                <p>
                  ...
                  HauntedSea by clicking the wallet icon in the top right
                  corner. Learn about the <span>wallets we support.</span>
                </p>
              </div>
              ...
              <div className={styles.card5}>
                ...
                <p>
                  Click <span>My Collections</span> and set up your collection.
        ...
        <section className={styles.section6}>
          ...
          <div className={styles.section6content}>
            ...
            <p>
              The SeaVerse is a world where Artists can build, own, and monetize
              their assets and virtual experiences onthe Fantom Opera Network.
              Customize your avatar, create items, and monetize your unique
              items through NFTs.
              <br />
              <br />
              We empower artists and creators to build the platform they always
              envisioned, providing the means to unleash your creativity and
              earn income
            </p>
          </div>
        </section>
        ...
        <section className={styles.section8}>
          ...
          <p>
            HauntedSea is the First decentralised NFT marketplace and Virtual
            World on the Fantom Opera Network.
            <br />
            Join the discussions on Telegram and stay up to date with the latest
